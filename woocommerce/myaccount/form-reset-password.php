...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="rest_pswd_title"><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="button-secondary" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>">
		<span class="button_label"><?php esc_html_e( 'Save', 'woocommerce' ); ?></span>
	</button>
	</p>
